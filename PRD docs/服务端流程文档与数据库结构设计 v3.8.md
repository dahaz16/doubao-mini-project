...
|--------------------------|----------------------------------------------------|----------------------------------------------------|----------------------------------------------------|
| **Caching (缓存策略)**       | **Enabled** (Session 模式)                           | **Enabled** (Session 模式)                           | **Enabled** (Session 模式)                           |
| **Previous Response ID** | **有值时：** 传入 previous_response_id<br>**无值时：** 不传此字段 | **有值时：** 传入 previous_response_id<br>**无值时：** 不传此字段 | **有值时：** 传入 previous_response_id<br>**无值时：** 不传此字段 |
...
"type": "memory",
"memory_content": {
"S": [{ "pt": "n/u", "tid": "s1", "id": 123, "title": "...", "summary": "...", "content": "..." }],
"T": [{ "pt": "n/u", "tid": "t1", "id": 456, "title": "...", "summary": "...", "content": "..." }],
"O": [{ "pt": "n/u", "tid": "o1", "id": 789, "title": "...", "summary": "...", "content": "...", "shot_type": 2 }],
"C": [{ "pt": "n/u", "tid": "c1", "id": 001, "name": "...", "relation": "..." }],
"R": [{ "type": "link/unlink", "src": "t1", "tgt": "s1" }, { "type": "link/unlink", "src": "c1", "tgt": "o1" }]
}
}
```
5. **Stn 输出成功后的处理**： 
...
| intv_llm_session_id                   | VARCHAR(128) | -                       | -                                                          | LLM SDK 返回的 Session ID (采访员)    |
| stn_llm_session_id                    | VARCHAR(128) | -                       | -                                                          | LLM SDK 返回的 Session ID (速记员)    |
| dir_llm_session_id                    | VARCHAR(128) | -                       | -                                                          | LLM SDK 返回的 Session ID (导演)     |
